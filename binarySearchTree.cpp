...
class BinaryTree
{
    ...
    void insert()
    {
        ...
        // Step 6: If the value in the data field of new node is less then that of parent
        if (x < parent->info)
        {
        ...
        // Step 7: If the value in the data field of new node greater then that of the parent
